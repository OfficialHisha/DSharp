...
namespace DSharp.Dlive
{
    public struct UserData
    {
        ...
        public UserData(string username, string displayname, PartnerStatus partnerStatus, bool live, string effect, Badge[] badges, bool deactivated, AboutPanel[] panels, Uri avatar, long followerCount,
                        long chest, long balance, long totalEarnings, long subscriberCount, string email, string[] wordFilter, string streamKey)
        {
            Public = new PublicUserData(username, displayname, partnerStatus, live, effect, badges, deactivated, panels, avatar, followerCount, chest, balance, totalEarnings);
